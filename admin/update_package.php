...
if(isset($_POST['submit'])){
  ...
  $query="UPDATE package SET packname='{$packname}',price='{$price}',image='{$new_name}' WHERE id='{$id}'";
...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <h1 class="admin-heading">Update Package</h1>
    </div>
 ...
 ?>        
        ...
        <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="packname"  class="form-control" id="exampleInputUsername" value="<?php echo  $row['packname']; ?>">
            </div>
