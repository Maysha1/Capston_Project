...
if(isset($_POST['submit'])){
  $title=mysqli_real_escape_string($conn,$_POST['mealname']);
  ...
  $query="INSERT INTO meal (mealname,description,price,image) VALUES('$title','$description','$venue','$new_name')";
...
?>
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <h1 class="admin-heading">Add Meal Information</h1>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <form  action="<?php $_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input type="text" name="mealname" class="form-control" autocomplete="off" required>
                      </div>
